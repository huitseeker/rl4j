...
public class MalmoObservationSpaceGrid extends MalmoObservationSpace
{
	...
	{
		//TODO: Try just returning Nd4j.create( getShape() );
	...
	{
		//TODO: Try using return Nd4j.linspace( size, size, totalSize );
		INDArray high = Nd4j.create( getShape() );

		for( int i = 0; i < totalSize; ++i )
			high.putScalar( i, size );
